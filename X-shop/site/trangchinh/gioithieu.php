<main class="main">
            ...
            <div class="container">
	        	<div class="page-header page-header-big text-center" style="background-image: url('<?=$IMAGE_SITE_URL?>/demos/demo-3/slider/slider.png')">
        			<h1 class="page-title text-black">Giới thiệu<span class="text-black">Chúng tôi là ai</span></h1>
	        	</div><!-- End .page-header -->
            </div><!-- End .container -->
            ...
            <div class="page-content pb-0">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <h2 class="title">Nhiệm vụ của chúng tôi</h2><!-- End .title -->
                    ...
                    <div class="container">
                        ...
                        <div class="owl-carousel owl-simple owl-testimonials-photo" data-toggle="owl" 
                            ...
                            <blockquote class="testimonial text-center">
                                <img src="<?=$IMAGE_SITE_URL?>/testimonials/user-1.jpg" alt="user">
                            ...
                            <blockquote class="testimonial text-center">
                                <img src="<?=$IMAGE_SITE_URL?>/testimonials/user-2.jpg" alt="user">
