        ...
        <div class="intro-slider owl-carousel owl-simple owl-dark owl-nav-inside" data-toggle="owl" data-owl-options='{
            ...
            <div class="intro-slide">
                <figure class="slide-image">
                    <picture>
                        <source media="(max-width: 480px)" srcset="<?=$IMAGE_SITE_URL?>/demos/demo-3/slider/slider-480w.png">
                        <img src="<?=$IMAGE_SITE_URL?>/demos/demo-3/slider/slider.png" alt="Image Desc">
                    </picture>
                ...
                <div class="intro-content">
                    ...
                    <a href="../sanpham/index-chitiet.php?MaSP=55" class="btn btn-primary btn-round">
                        <span>Mua ngay</span>
            ...
            <div class="intro-slide">
                <figure class="slide-image">
                    <picture>
                        <source media="(max-width: 480px)" srcset="<?=$IMAGE_SITE_URL?>/demos/demo-3/slider/slider2-480w.png">
                        <img src="<?=$IMAGE_SITE_URL?>/demos/demo-3/slider/slider2.png" alt="Image Desc">
                    </picture>
                </figure><!-- End .slide-image -->
                ...
                <div class="intro-content">
                    ...
                    <div class="intro-price">
                        <sup class="intro-old-price">9.000.000 đ</sup>
                        <span class="text-primary">
                            8.690.000 đ
                        </span>
                    </div><!-- End .intro-price -->

                    <a href="../sanpham/index-chitiet.php?MaSP=68" class="btn btn-primary btn-round">
                        <span>Mua ngay</span>
                        <i class="icon-long-arrow-right"></i>
                    </a>
                </div><!-- End .intro-content -->
...
<div class="col-lg-4">
    <div class="intro-banners">
        <div class="banner mb-lg-1 mb-xl-2">
            <a href="#">
                <img src="<?=$IMAGE_SITE_URL?>/demos/demo-3/banners/banner-1.jpg" alt="Banner">
            </a>
        ...
        <div class="banner mb-lg-1 mb-xl-2">
            <a href="#">
                <img src="<?=$IMAGE_SITE_URL?>/demos/demo-3/banners/banner-2.jpg" alt="Banner">
            </a>
        ...
        <div class="banner mb-0">
            <a href="#">
                <img src="<?=$IMAGE_SITE_URL?>/demos/demo-3/banners/banner-3.jpg" alt="Banner">
            </a>
